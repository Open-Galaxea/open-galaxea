...
class PoseRotationTransformer:
    def __init__(self, rotation_type: Literal["quaternion", "rotation_6d", "rotation_9d"]="quaternion"):
    ...
    def add_noise(self, pose, std_position=0.05, std_angle=0.05):
        assert pose.shape[-1] == 7
        position = pose[..., 0: 3]
        quaternion = pose[..., [6, 3, 4, 5]]
